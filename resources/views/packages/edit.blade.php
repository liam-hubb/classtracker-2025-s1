                            ...
                            <div class="min-w-full text-left text-sm font-light text-surface dark:text-white">
                                ...
                                <section
                                    ...
                                    <div class="flex flex-col my-2">
                                        ...
                                        <x-text-input id="national_code" name="national_code" value="{{ old('national_code') ?? $package->national_code}}"/>
                                    ...
                                    <div class="flex flex-col my-2">
                                        ...
                                        <x-text-input id="title" name="title" value="{{ old('title') ?? $package->title }}"/>
                                    ...
                                    <div class="flex flex-col my-2">
                                        ...
                                        <x-text-input id="tga_status" name="tga_status" value="{{ old('tga_status') ?? $package->tga_status }}"/>
